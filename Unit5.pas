...
var
 ...
 vihod: array of real;
 chislo: integer;
chislo1: real; //для лин.конгруэнтного метода
s1: string;     //для лин.конгр. метода
chislo_max, chislo_min:  real; //значения для гистограммы
